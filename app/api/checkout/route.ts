    ...
    if (checkout.provider === "stripe") {
      const session = await getStripe().checkout.sessions.create({
        ...
        metadata: {
          ...
          pickupId: checkout.pickup.id,
          pickupKind: checkout.pickup.kind,
          pickupLabel: checkout.pickup.label,
          pickupDetail: checkout.pickup.detail,
          name: checkout.name,
